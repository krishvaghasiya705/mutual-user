...
import Sliderwerdebackgroundshape from "../../../assets/svg/sliderwerdebackgroundshape.svg";
...
export default function Werdeslider() {
  ...
  return (
    <div className="werde-slider-section">
      <div className="slider-werde-background-shape">
        <img src={Sliderwerdebackgroundshape} alt="Sliderwerdebackgroundshape" />
      </div>
